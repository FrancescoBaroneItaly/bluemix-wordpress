...
class IBM_Provider extends Provider {
	 ...
	 * @var string
	 */
	protected static $provider_name = 'IBM cloud';

	/**
	 * @var string
	 */
	protected static $provider_short_name = 'IBM';
	 ...
	 * @var string
	 */
	protected static $provider_key_name = 'ibm';
	 ...
	 * @var string
	 */
	protected static $provider_service_name = 'IBM S3';
	 ...
	 * @var string
	 */
	protected $console_url = 'https://console.bluemix.net/objectstorage';
